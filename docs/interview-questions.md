### 第01章 Python基础（12 道） { .toc-chapter }
...
### 第03章 NLP基础与Tokenization（12 道） { .toc-chapter }
...
### 第04章 Transformer架构详解（12 道） { .toc-chapter }
...
### 第05章 大模型原理与发展脉络（10 道） { .toc-chapter }
...
### 第06章 大模型API调用实战（10 道） { .toc-chapter }
...
### 第07章 PromptEngineering提示词工程（10 道） { .toc-chapter }
...
### 第08章 Embedding与向量数据库（11 道） { .toc-chapter }
...
### 第09章 RAG检索增强生成（10 道） { .toc-chapter }
...
### 第10章 LangChain与LangGraph实战（10 道） { .toc-chapter }
...
### 第11章 AI_Agent开发（10 道） { .toc-chapter }
...
### 第12章 多Agent系统（10 道） { .toc-chapter }
