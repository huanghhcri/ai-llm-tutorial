...
<a id="第03章-nlp基础与tokenization"></a>
...
<a id="第07章-prompt-engineering"></a>
??? note "第07章 PromptEngineering提示词工程（10 道）"
    ...
    - [78. DSPy 框架是什么？它如何自动化 Prompt 优化？ ⭐⭐⭐](#题目-78dspy-框架是什么它如何自动化-prompt-优化)

<a id="第08章-embedding与向量数据库"></a>
??? note "第08章 Embedding与向量数据库（11 道）"
...
??? note "第09章 RAG检索增强生成（10 道）"
    ...
    - [97. 如何优化 RAG 系统的延迟（响应速度）？ ⭐⭐](#题目-97如何优化-rag-系统的延迟响应速度)
    - [98. RAG 和微调（Fine-tuning）有什么区别？什么时候用哪个？ ⭐⭐](#题目-98rag-和微调fine-tuning有什么区别什么时候用哪个)
    - [99. 如何将 RAG 系统集成到 ASP.NET Core 项目中？ ⭐⭐⭐](#题目-99如何将-rag-系统集成到-aspnet-core-项目中)

<a id="第10章-langchain与langgraph"></a>
...
<a id="第12章-多agent系统"></a>
??? note "第12章 多Agent系统（10 道）"

    - [120. 多 Agent 系统相比单 Agent 有什么优势和劣势？ ⭐⭐](#题目-120多-agent-系统相比单-agent-有什么优势和劣势)
    - [121. 层级式、对等式、流水线式三种多 Agent 架构分别适合什么场景？ ⭐⭐](#题目-121层级式对等式流水线式三种多-agent-架构分别适合什么场景)
    - [122. 如何设计 Agent 之间的通信机制？ ⭐⭐](#题目-122如何设计-agent-之间的通信机制)
    - [123. 如何处理多个 Agent 给出矛盾建议的情况？ ⭐⭐](#题目-123如何处理多个-agent-给出矛盾建议的情况)
    - [124. CrewAI 的 Agent-Task-Crew 模型是什么？ ⭐](#题目-124crewai-的-agent-task-crew-模型是什么)
...
??? note "第13章 模型微调（10 道）"
    ...
    - [137. Unsloth 的加速原理是什么？ ⭐⭐](#题目-137unsloth-的加速原理是什么)
    - [138. 微调后的模型如何部署？ ⭐⭐](#题目-138微调后的模型如何部署)
    - [139. LoRA 的 rank 参数如何选择？ ⭐⭐](#题目-139lora-的-rank-参数如何选择)
...
??? note "第14章 模型量化（10 道）"
    ...
    - [147. 什么是 Group Size？它如何影响量化质量？ ⭐⭐](#题目-147什么是-group-size它如何影响量化质量)
    - [148. Ollama 和 vLLM 分别适合什么场景？ ⭐](#题目-148ollama-和-vllm-分别适合什么场景)
    - [149. 如何将量化后的模型集成到 ASP.NET Core 后端？ ⭐⭐⭐](#题目-149如何将量化后的模型集成到-aspnet-core-后端)

<a id="第15章-私有化部署"></a>
??? note "第15章 私有化部署（10 道）"
    ...
    - [159. 完整的养老院 AI 部署架构是什么样的？ ⭐⭐⭐](#题目-159完整的养老院-ai-部署架构是什么样的)

<a id="第16章-多模态大模型"></a>
??? note "第16章 多模态大模型（10 道）"

    - [160. 什么是 VLM？它和纯文本大模型有什么区别？ ⭐](#题目-160什么是-vlm它和纯文本大模型有什么区别)
    - [161. 如何通过 API 发送图片给多模态模型？ ⭐](#题目-161如何通过-api-发送图片给多模态模型)
    - [162. 什么是多模态 RAG？它和纯文本 RAG 有什么区别？ ⭐⭐](#题目-162什么是多模态-rag它和纯文本-rag-有什么区别)
    - [163. 如何用 VLM 做 OCR（文字识别）？ ⭐](#题目-163如何用-vlm-做-ocr文字识别)
    - [164. 本地部署多模态模型需要什么硬件？ ⭐](#题目-164本地部署多模态模型需要什么硬件)
    - [165. 多模态 Agent 的工作流程是什么？ ⭐⭐](#题目-165多模态-agent-的工作流程是什么)
    - [166. Base64 编码图片有什么优缺点？ ⭐](#题目-166base64-编码图片有什么优缺点)
    - [167. 如何评估多模态模型的图片理解能力？ ⭐⭐](#题目-167如何评估多模态模型的图片理解能力)
    - [168. 多模态模型和传统 OCR + LLM 的方案有什么区别？ ⭐⭐](#题目-168多模态模型和传统-ocr-llm-的方案有什么区别)
    - [169. 如何将多模态能力集成到养老院的 ASP.NET Core 系统中？ ⭐⭐⭐](#题目-169如何将多模态能力集成到养老院的-aspnet-core-系统中)

<a id="第17章-模型评估与对齐"></a>
??? note "第17章 模型评估与对齐（10 道）"

    - [170. 什么是 RLHF？它的三个阶段分别做什么？ ⭐⭐](#题目-170什么是-rlhf它的三个阶段分别做什么)
    - [171. DPO 和 RLHF 有什么区别？为什么 DPO 更流行？ ⭐⭐](#题目-171dpo-和-rlhf-有什么区别为什么-dpo-更流行)
    - [172. 什么是 LLM-as-Judge？它有什么优缺点？ ⭐⭐](#题目-172什么是-llm-as-judge它有什么优缺点)
    - [173. 养老院 AI 需要做哪些安全测试？ ⭐⭐](#题目-173养老院-ai-需要做哪些安全测试)
    - [174. 什么是 KL 散度？它在 RLHF 中的作用是什么？ ⭐⭐](#题目-174什么是-kl-散度它在-rlhf-中的作用是什么)
    - [175. 如何构建养老院 AI 的评估数据集？ ⭐⭐](#题目-175如何构建养老院-ai-的评估数据集)
    - [176. 什么是红队测试（Red Teaming）？ ⭐](#题目-176什么是红队测试red-teaming)
    - [177. 对齐税（Alignment Tax）是什么？ ⭐⭐⭐](#题目-177对齐税alignment-tax是什么)
    - [178. 如何持续改进已部署的 AI 模型？ ⭐⭐](#题目-178如何持续改进已部署的-ai-模型)
    - [179. 如何确保养老院 AI 的长期可靠性？ ⭐⭐⭐](#题目-179如何确保养老院-ai-的长期可靠性)
...
<a id="题目1python的list和c的listt有什么本质区别"></a>
<a id="题目-1python-的-list-和-c-的-listt-有什么本质区别"></a>
...
<a id="题目2python的self和c的this有什么区别为什么python要显式写self"></a>
<a id="题目-2python-的-self-和-c-的-this-有什么区别为什么-python-要显式写-self"></a>
...
<a id="题目3什么是python的gil它对ai开发有什么影响"></a>
<a id="题目-3什么是-python-的-gil它对-ai-开发有什么影响"></a>
...
<a id="题目4解释python装饰器的工作原理以及它和c的attribute有什么不同"></a>
<a id="题目-4解释-python-装饰器的工作原理以及它和-c-的-attribute-有什么不同"></a>
...
<a id="题目5@dataclass和普通class有什么区别什么场景下使用"></a>
<a id="题目-5dataclass-和普通-class-有什么区别什么场景下使用"></a>
...
<a id="题目6python的list切片a[13]返回什么如果a=[01234]"></a>
<a id="题目-6python-的-list-切片-a13-返回什么如果-a-0-1-2-3-4"></a>
...
<a id="题目7python的is和==有什么区别"></a>
<a id="题目-7python-的-is-和-有什么区别"></a>
...
<a id="题目8python的异常处理中exceptexceptionase和exceptvalueerrortypeerrorase有什么区别为什么要尽量捕获具体异常"></a>
<a id="题目-8python-的异常处理中except-exception-as-e-和-except-valueerror-typeerror-as-e-有什么区别为什么要尽量捕获具体异常"></a>
...
<a id="题目9解释python的asyncio和c的task异步模型的异同"></a>
<a id="题目-9解释-python-的-asyncio-和-c-的-task-异步模型的异同"></a>
...
<a id="题目10python的虚拟环境是什么为什么ai开发特别需要它"></a>
<a id="题目-10python-的虚拟环境是什么为什么-ai-开发特别需要它"></a>
...
<a id="题目11python的dict和c的dictionarytkeytvalue在性能和使用上有什么差异"></a>
<a id="题目-11python-的-dict-和-c-的-dictionarytkey-tvalue-在性能和使用上有什么差异"></a>
...
<a id="题目12什么是python的猴子补丁monkeypatching在ai开发中有什么应用场景"></a>
<a id="题目-12什么是-python-的猴子补丁monkey-patching在-ai-开发中有什么应用场景"></a>
...
<a id="题目13什么是梯度消失问题relu是如何缓解的"></a>
<a id="题目-13什么是梯度消失问题relu-是如何缓解的"></a>
...
<a id="题目14为什么深度学习需要激活函数如果全部用线性激活会怎样"></a>
<a id="题目-14为什么深度学习需要激活函数如果全部用线性激活会怎样"></a>
...
<a id="题目15比较batchnormalization和layernormalization它们分别用在什么场景"></a>
<a id="题目-15比较-batch-normalization-和-layer-normalization它们分别用在什么场景"></a>
...
<a id="题目16adam优化器的原理是什么它比sgd好在哪里"></a>
<a id="题目-16adam-优化器的原理是什么它比-sgd-好在哪里"></a>
...
<a id="题目17什么是dropout为什么它能防止过拟合推理时怎么处理"></a>
<a id="题目-17什么是-dropout为什么它能防止过拟合推理时怎么处理"></a>
...
<a id="题目18解释precision、recall、f1score的含义和区别以及在医疗场景中如何选择"></a>
<a id="题目-18解释-precisionrecallf1-score-的含义和区别以及在医疗场景中如何选择"></a>
...
<a id="题目19pytorch中model.train和model.eval的区别是什么不切换会有什么后果"></a>
<a id="题目-19pytorch-中-modeltrain-和-modeleval-的区别是什么不切换会有什么后果"></a>
...
<a id="题目20什么是学习率预热warmup为什么大模型训练需要它"></a>
<a id="题目-20什么是学习率预热warmup为什么大模型训练需要它"></a>
...
<a id="题目21解释前向传播和反向传播的计算过程以及pytorch如何自动求导"></a>
<a id="题目-21解释前向传播和反向传播的计算过程以及-pytorch-如何自动求导"></a>
...
<a id="题目22数据标准化standardscaler为什么重要如果不做会怎样"></a>
<a id="题目-22数据标准化standardscaler为什么重要如果不做会怎样"></a>
...
<a id="题目23什么是类别不平衡如何处理请举例说明"></a>
<a id="题目-23什么是类别不平衡如何处理请举例说明"></a>
...
<a id="题目24解释pytorch的动态计算图与tensorflow的静态计算图的区别以及pytorch为什么更受欢迎"></a>
<a id="题目-24解释-pytorch-的动态计算图与-tensorflow-的静态计算图的区别以及-pytorch-为什么更受欢迎"></a>
...
<a id="题目25为什么不用one-hot编码作为大模型的输入"></a>
<a id="题目-25为什么不用-one-hot-编码作为大模型的输入"></a>
...
<a id="题目26解释bpe和wordpiece的区别以及它们分别被哪些模型使用"></a>
<a id="题目-26解释-bpe-和-wordpiece-的区别以及它们分别被哪些模型使用"></a>
...
<a id="题目27什么是token为什么大模型按token收费而不是按字符收费"></a>
<a id="题目-27什么是-token为什么大模型按-token-收费而不是按字符收费"></a>
...
<a id="题目28word2vec的skip-gram和cbow模型有什么区别各自适合什么场景"></a>
<a id="题目-28word2vec-的-skip-gram-和-cbow-模型有什么区别各自适合什么场景"></a>
...
<a id="题目29什么是oovout-of-vocabulary问题子词分词如何解决"></a>
<a id="题目-29什么是-oovout-of-vocabulary问题子词分词如何解决"></a>
...
<a id="题目30如何用词向量计算文档相似度这种方法有什么局限性"></a>
<a id="题目-30如何用词向量计算文档相似度这种方法有什么局限性"></a>
...
<a id="题目31为什么中文分词比英文分词更难大模型还需要中文分词吗"></a>
<a id="题目-31为什么中文分词比英文分词更难大模型还需要中文分词吗"></a>
...
<a id="题目32解释embedding层的工作原理以及它和word2vec的区别"></a>
<a id="题目-32解释-embedding-层的工作原理以及它和-word2vec-的区别"></a>
...
<a id="题目33tiktoken的cl100k_base和o200k_base有什么区别选择哪个"></a>
<a id="题目-33tiktoken-的-cl100k_base-和-o200k_base-有什么区别选择哪个"></a>
...
<a id="题目34什么是上下文窗口contextwindow它对养老院ai应用有什么影响"></a>
<a id="题目-34什么是上下文窗口context-window它对养老院-ai-应用有什么影响"></a>
...
<a id="题目35解释tf-idf的原理为什么它比简单的词频统计更好"></a>
<a id="题目-35解释-tf-idf-的原理为什么它比简单的词频统计更好"></a>
...
<a id="题目36如果要为养老院构建rag系统文档的tokenization策略应该怎么设计"></a>
<a id="题目-36如果要为养老院构建-rag-系统文档的-tokenization-策略应该怎么设计"></a>
...
<a id="题目37解释self-attention的计算过程以及为什么需要除以√dₖ"></a>
<a id="题目-37解释-self-attention-的计算过程以及为什么需要除以-dₖ"></a>
...
<a id="题目38多头注意力相比单头注意力的优势是什么为什么头数通常是8或12"></a>
<a id="题目-38多头注意力相比单头注意力的优势是什么为什么头数通常是-8-或-12"></a>
...
<a id="题目39rope相比正弦位置编码和可学习位置编码有什么优势为什么llama选择rope"></a>
<a id="题目-39rope-相比正弦位置编码和可学习位置编码有什么优势为什么-llama-选择-rope"></a>
...
<a id="题目40为什么transformer使用layernorm而不是batchnorm"></a>
<a id="题目-40为什么-transformer-使用-layernorm-而不是-batchnorm"></a>
...
<a id="题目41解释残差连接的作用原理以及没有残差连接会怎样"></a>
<a id="题目-41解释残差连接的作用原理以及没有残差连接会怎样"></a>
...
<a id="题目42编码器encoder和解码器decoder的核心区别是什么bert和gpt分别使用哪种"></a>
<a id="题目-42编码器encoder和解码器decoder的核心区别是什么bert-和-gpt-分别使用哪种"></a>
...
<a id="题目43什么是ffn前馈网络在transformer中的作用为什么d_ff通常是d_model的4倍"></a>
<a id="题目-43什么是-ffn前馈网络在-transformer-中的作用为什么-d_ff-通常是-d_model-的-4-倍"></a>
...
<a id="题目44什么是注意力掩码attentionmask有哪些类型"></a>
<a id="题目-44什么是注意力掩码attention-mask有哪些类型"></a>
...
<a id="题目45transformer的计算复杂度是多少为什么长序列处理很昂贵"></a>
<a id="题目-45transformer-的计算复杂度是多少为什么长序列处理很昂贵"></a>
...
<a id="题目46解释pre-norm和post-norm的区别以及现代模型为什么选择pre-norm"></a>
<a id="题目-46解释-pre-norm-和-post-norm-的区别以及现代模型为什么选择-pre-norm"></a>
...
<a id="题目47什么是kvcache为什么它对大模型推理至关重要"></a>
<a id="题目-47什么是-kv-cache为什么它对大模型推理至关重要"></a>
...
<a id="题目48对比bert、gpt和t5三种transformer变体的架构差异和适用场景"></a>
<a id="题目-48对比-bertgpt-和-t5-三种-transformer-变体的架构差异和适用场景"></a>
...
<a id="题目49解释scalinglaw的核心发现以及它对大模型训练的实际指导意义"></a>
<a id="题目-49解释-scaling-law-的核心发现以及它对大模型训练的实际指导意义"></a>
...
<a id="题目50什么是moemixtureofexperts架构它解决了什么问题"></a>
<a id="题目-50什么是-moemixture-of-experts架构它解决了什么问题"></a>
...
<a id="题目51对比qwen和deepseek的技术路线差异你会为养老院项目选择哪个"></a>
<a id="题目-51对比-qwen-和-deepseek-的技术路线差异你会为养老院项目选择哪个"></a>
...
<a id="题目52什么是涌现能力emergentabilities这个概念现在还有争议吗"></a>
<a id="题目-52什么是涌现能力emergent-abilities这个概念现在还有争议吗"></a>
...
<a id="题目53上下文窗口的大小对养老院ai应用有什么实际影响"></a>
<a id="题目-53上下文窗口的大小对养老院-ai-应用有什么实际影响"></a>
...
<a id="题目54开源模型和闭源模型各有什么优势如何选择"></a>
<a id="题目-54开源模型和闭源模型各有什么优势如何选择"></a>
...
<a id="题目55解释deepseek-v3/v4的mlamulti-latentattention相比标准注意力有什么优势"></a>
<a id="题目-55解释-deepseek-v3v4-的-mlamulti-latent-attention相比标准注意力有什么优势"></a>
...
<a id="题目56chinchillascalinglaw认为gpt-3存在什么问题对现在的模型训练有什么启示"></a>
<a id="题目-56chinchilla-scaling-law-认为-gpt-3-存在什么问题对现在的模型训练有什么启示"></a>
...
<a id="题目57llama-4的架构有什么创新为什么它有128个专家但只激活17b"></a>
<a id="题目-57llama-4-的架构有什么创新为什么它有-128-个专家但只激活-17b"></a>
...
<a id="题目58为养老院设计一个大模型集成方案如何结合多个模型的优势"></a>
<a id="题目-58为养老院设计一个大模型集成方案如何结合多个模型的优势"></a>
...
<a id="题目59解释chatcompletionsapi中system、user、assistant、tool四种角色的区别"></a>
<a id="题目-59解释-chat-completions-api-中-systemuserassistanttool-四种角色的区别"></a>
...
<a id="题目60temperature参数如何影响大模型的输出不同场景应该如何设置"></a>
<a id="题目-60temperature-参数如何影响大模型的输出不同场景应该如何设置"></a>
...
<a id="题目61functioncalling的完整流程是什么有哪些注意事项"></a>
<a id="题目-61function-calling-的完整流程是什么有哪些注意事项"></a>
...
<a id="题目62为什么deepseek和qwen的api可以用openai的sdk调用这种兼容性有什么意义"></a>
<a id="题目-62为什么-deepseek-和-qwen-的-api-可以用-openai-的-sdk-调用这种兼容性有什么意义"></a>
...
<a id="题目63如何实现流式输出它解决了什么用户体验问题"></a>
<a id="题目-63如何实现流式输出它解决了什么用户体验问题"></a>
...
<a id="题目64如何管理多轮对话的上下文当对话太长时怎么办"></a>
<a id="题目-64如何管理多轮对话的上下文当对话太长时怎么办"></a>
...
<a id="题目65api调用中的错误类型有哪些如何设计健壮的重试策略"></a>
<a id="题目-65api-调用中的错误类型有哪些如何设计健壮的重试策略"></a>
...
<a id="题目66如何估算和控制大模型api的调用成本"></a>
<a id="题目-66如何估算和控制大模型-api-的调用成本"></a>
...
<a id="题目67response_format={typejson_object}参数的作用是什么有什么限制"></a>
<a id="题目-67response_formattype-json_object-参数的作用是什么有什么限制"></a>
...
<a id="题目68openaisdk的同步客户端和异步客户端有什么区别asp.netcore开发者应该如何选择"></a>
<a id="题目-68openai-sdk-的同步客户端和异步客户端有什么区别aspnet-core-开发者应该如何选择"></a>
...
<a id="题目69zero-shot、few-shot、chain-of-thought三种提示策略分别适合什么场景"></a>
<a id="题目-69zero-shotfew-shotchain-of-thought-三种提示策略分别适合什么场景"></a>
...
<a id="题目70如何设计一个好的systemprompt有哪些常见错误"></a>
<a id="题目-70如何设计一个好的-system-prompt有哪些常见错误"></a>
...
<a id="题目71什么是chain-of-thought为什么它能提升推理准确率"></a>
<a id="题目-71什么是-chain-of-thought为什么它能提升推理准确率"></a>
...
<a id="题目72什么是promptinjection如何防御"></a>
<a id="题目-72什么是-prompt-injection如何防御"></a>
...
<a id="题目73如何让大模型输出稳定的json格式有哪些注意事项"></a>
<a id="题目-73如何让大模型输出稳定的-json-格式有哪些注意事项"></a>
...
<a id="题目74few-shot提示中示例的选择对结果有多大影响如何选择好的示例"></a>
<a id="题目-74few-shot-提示中示例的选择对结果有多大影响如何选择好的示例"></a>
...
<a id="题目75什么是promptchaining什么时候应该使用它"></a>
<a id="题目-75什么是-prompt-chaining什么时候应该使用它"></a>
...
<a id="题目76temperature和top_p有什么区别应该如何选择"></a>
<a id="题目-76temperature-和-top_p-有什么区别应该如何选择"></a>
...
<a id="题目77如何评估prompt的质量有哪些量化方法"></a>
<a id="题目-77如何评估-prompt-的质量有哪些量化方法"></a>
...
<a id="题目78dspy框架是什么它如何自动化prompt优化"></a>
<a id="题目-78dspy-框架是什么它如何自动化-prompt-优化"></a>
...
<a id="题目79什么是embedding它和one-hot编码有什么区别"></a>
<a id="题目-79什么是-embedding它和-one-hot-编码有什么区别"></a>
...
<a id="题目80什么是余弦相似度为什么用它而不是欧氏距离"></a>
<a id="题目-80什么是余弦相似度为什么用它而不是欧氏距离"></a>
...
<a id="题目81为什么需要文档切分切分粒度如何选择"></a>
<a id="题目-81为什么需要文档切分切分粒度如何选择"></a>
...
<a id="题目82对比chroma、qdrant、milvus三个向量数据库如何选择"></a>
<a id="题目-82对比-chromaqdrantmilvus-三个向量数据库如何选择"></a>
...
<a id="题目83什么是ann近似最近邻它和精确搜索有什么区别"></a>
<a id="题目-83什么是-ann近似最近邻它和精确搜索有什么区别"></a>
...
<a id="题目84chunk_overlap的作用是什么没有它会有什么问题"></a>
<a id="题目-84chunk_overlap-的作用是什么没有它会有什么问题"></a>
...
<a id="题目85如何评估embedding模型的质量"></a>
<a id="题目-85如何评估-embedding-模型的质量"></a>
...
<a id="题目86向量数据库的过滤功能是什么为什么重要"></a>
<a id="题目-86向量数据库的过滤功能是什么为什么重要"></a>
...
<a id="题目87什么是混合检索hybridsearch它解决了什么问题"></a>
<a id="题目-87什么是混合检索hybrid-search它解决了什么问题"></a>
...
<a id="题目88如何处理embedding的成本问题"></a>
<a id="题目-88如何处理-embedding-的成本问题"></a>
...
<a id="题目89如何将embedding+向量数据库集成到养老院的asp.netcore系统中"></a>
<a id="题目-89如何将-embedding-向量数据库集成到养老院的-aspnet-core-系统中"></a>
...
<a id="题目90什么是rag它解决了大模型的哪些问题"></a>
<a id="题目-90什么是-rag它解决了大模型的哪些问题"></a>
...
<a id="题目91re-ranking的作用是什么为什么有了embedding检索还需要re-ranking"></a>
<a id="题目-91re-ranking-的作用是什么为什么有了-embedding-检索还需要-re-ranking"></a>
...
<a id="题目92query改写解决了什么问题有哪些改写策略"></a>
<a id="题目-92query-改写解决了什么问题有哪些改写策略"></a>
...
<a id="题目93什么是self-rag和correctiverag它们比标准rag好在哪里"></a>
<a id="题目-93什么是-self-rag-和-corrective-rag它们比标准-rag-好在哪里"></a>
...
<a id="题目94如何评估rag系统的质量ragas的四个指标分别衡量什么"></a>
<a id="题目-94如何评估-rag-系统的质量ragas-的四个指标分别衡量什么"></a>
...
<a id="题目95文档切分的chunk_size如何选择太大或太小有什么问题"></a>
<a id="题目-95文档切分的-chunk_size-如何选择太大或太小有什么问题"></a>
...
<a id="题目96rag系统如何处理知识库中没有答案的情况"></a>
<a id="题目-96rag-系统如何处理知识库中没有答案的情况"></a>
...
<a id="题目97如何优化rag系统的延迟响应速度"></a>
<a id="题目-97如何优化-rag-系统的延迟响应速度"></a>
...
<a id="题目98rag和微调fine-tuning有什么区别什么时候用哪个"></a>
<a id="题目-98rag-和微调fine-tuning有什么区别什么时候用哪个"></a>
...
<a id="题目99如何将rag系统集成到asp.netcore项目中"></a>
<a id="题目-99如何将-rag-系统集成到-aspnet-core-项目中"></a>
...
<a id="题目100langchain的lcel是什么它解决了什么问题"></a>
<a id="题目-100langchain-的-lcel-是什么它解决了什么问题"></a>
...
<a id="题目101langgraph和langchainchain有什么区别什么时候用langgraph"></a>
<a id="题目-101langgraph-和-langchain-chain-有什么区别什么时候用-langgraph"></a>
...
<a id="题目102langchain的runnable协议是什么invoke/stream/batch有什么区别"></a>
<a id="题目-102langchain-的-runnable-协议是什么invokestreambatch-有什么区别"></a>
...
<a id="题目103如何用langchain实现带结构化输出的rag"></a>
<a id="题目-103如何用-langchain-实现带结构化输出的-rag"></a>
...
<a id="题目104langgraph中如何实现条件分支和循环"></a>
<a id="题目-104langgraph-中如何实现条件分支和循环"></a>
...
<a id="题目105langsmith的作用是什么它对标.net生态的什么工具"></a>
<a id="题目-105langsmith-的作用是什么它对标-net-生态的什么工具"></a>
...
<a id="题目106langchain的with_structured_output和jsonoutputparser有什么区别"></a>
<a id="题目-106langchain-的-with_structured_output-和-jsonoutputparser-有什么区别"></a>
...
<a id="题目107如何在langgraph中实现人工审批human-in-the-loop"></a>
<a id="题目-107如何在-langgraph-中实现人工审批human-in-the-loop"></a>
...
<a id="题目108langchain生态中各包的职责如何划分"></a>
<a id="题目-108langchain-生态中各包的职责如何划分"></a>
...
<a id="题目109对比langchain和llamaindex如何选择"></a>
<a id="题目-109对比-langchain-和-llamaindex如何选择"></a>
...
<a id="题目110什么是react模式它和普通的functioncalling有什么区别"></a>
<a id="题目-110什么是-react-模式它和普通的-function-calling-有什么区别"></a>
...
<a id="题目111mcpmodelcontextprotocol是什么它解决了什么问题"></a>
<a id="题目-111mcpmodel-context-protocol是什么它解决了什么问题"></a>
...
<a id="题目112如何给agent设计工具有哪些最佳实践"></a>
<a id="题目-112如何给-agent-设计工具有哪些最佳实践"></a>
...
<a id="题目113agent的记忆机制有哪些层次如何实现"></a>
<a id="题目-113agent-的记忆机制有哪些层次如何实现"></a>
...
<a id="题目114对比langgraph、openaiagentssdk、crewai三个agent框架"></a>
<a id="题目-114对比-langgraphopenai-agents-sdkcrewai-三个-agent-框架"></a>
...
<a id="题目115如何防止agent进入无限循环或做出危险操作"></a>
<a id="题目-115如何防止-agent-进入无限循环或做出危险操作"></a>
...
<a id="题目116mcpserver的三种能力tools、resources、prompts分别适合什么场景"></a>
<a id="题目-116mcp-server-的三种能力toolsresourcesprompts分别适合什么场景"></a>
...
<a id="题目117如何测试agent的可靠性"></a>
<a id="题目-117如何测试-agent-的可靠性"></a>
...
<a id="题目118什么是human-in-the-loop在养老院agent中如何实现"></a>
<a id="题目-118什么是-human-in-the-loop在养老院-agent-中如何实现"></a>
...
<a id="题目119如何将agent集成到asp.netcore后端"></a>
<a id="题目-119如何将-agent-集成到-aspnet-core-后端"></a>
...
<a id="题目120多agent系统相比单agent有什么优势和劣势"></a>
<a id="题目-120多-agent-系统相比单-agent-有什么优势和劣势"></a>
...
<a id="题目121层级式、对等式、流水线式三种多agent架构分别适合什么场景"></a>
<a id="题目-121层级式对等式流水线式三种多-agent-架构分别适合什么场景"></a>
...
<a id="题目122如何设计agent之间的通信机制"></a>
<a id="题目-122如何设计-agent-之间的通信机制"></a>
...
<a id="题目123如何处理多个agent给出矛盾建议的情况"></a>
<a id="题目-123如何处理多个-agent-给出矛盾建议的情况"></a>
...
<a id="题目124crewai的agent-task-crew模型是什么"></a>
<a id="题目-124crewai-的-agent-task-crew-模型是什么"></a>
...
<a id="题目125如何控制多agent系统的成本"></a>
<a id="题目-125如何控制多-agent-系统的成本"></a>
...
<a id="题目126如何确保多agent系统的一致性和可追溯性"></a>
<a id="题目-126如何确保多-agent-系统的一致性和可追溯性"></a>
...
<a id="题目127多agent系统如何处理某个agent失败的情况"></a>
<a id="题目-127多-agent-系统如何处理某个-agent-失败的情况"></a>
...
<a id="题目128对比langgraph和crewai实现多agent的方式"></a>
<a id="题目-128对比-langgraph-和-crewai-实现多-agent-的方式"></a>
...
<a id="题目129为养老院设计一个多agent系统的完整架构"></a>
<a id="题目-129为养老院设计一个多-agent-系统的完整架构"></a>
...
<a id="题目130lora的原理是什么为什么它能用极少的参数达到接近全参数微调的效果"></a>
<a id="题目-130lora-的原理是什么为什么它能用极少的参数达到接近全参数微调的效果"></a>
...
<a id="题目131qlora相比lora有什么改进nf4量化是什么"></a>
<a id="题目-131qlora-相比-lora-有什么改进nf4-量化是什么"></a>
...
<a id="题目132如何为养老院场景准备高质量的微调数据集"></a>
<a id="题目-132如何为养老院场景准备高质量的微调数据集"></a>
...
<a id="题目133全参数微调、lora、prompttuning三种微调方式有什么区别"></a>
<a id="题目-133全参数微调loraprompt-tuning-三种微调方式有什么区别"></a>
...
<a id="题目134微调和rag如何结合使用"></a>
<a id="题目-134微调和-rag-如何结合使用"></a>
...
<a id="题目135如何评估微调后的模型效果"></a>
<a id="题目-135如何评估微调后的模型效果"></a>
### 题目 135：如何评估微调后的模型效果？
...
<a id="题目136什么是过拟合微调时如何防止过拟合"></a>
<a id="题目-136什么是过拟合微调时如何防止过拟合"></a>
...
<a id="题目137unsloth的加速原理是什么"></a>
<a id="题目-137unsloth-的加速原理是什么"></a>
...
<a id="题目138微调后的模型如何部署"></a>
<a id="题目-138微调后的模型如何部署"></a>
### 题目 138：微调后的模型如何部署？
...
<a id="题目139lora的rank参数如何选择"></a>
<a id="题目-139lora-的-rank-参数如何选择"></a>
...
<a id="题目140量化的原理是什么为什么int4量化还能保持不错的效果"></a>
<a id="题目-140量化的原理是什么为什么-int4-量化还能保持不错的效果"></a>
...
<a id="题目141gptq和awq有什么区别如何选择"></a>
<a id="题目-141gptq-和-awq-有什么区别如何选择"></a>
...
<a id="题目142gguf格式的q4_k_m是什么意思不同量化级别如何选择"></a>
<a id="题目-142gguf-格式的-q4_k_m-是什么意思不同量化级别如何选择"></a>
...
<a id="题目143bitsandbytes的nf4是什么为什么比普通int4好"></a>
<a id="题目-143bitsandbytes-的-nf4-是什么为什么比普通-int4-好"></a>
...
<a id="题目144如何评估量化对模型质量的影响"></a>
<a id="题目-144如何评估量化对模型质量的影响"></a>
...
<a id="题目145cpu推理和gpu推理的速度差距有多大养老院应该选哪个"></a>
<a id="题目-145cpu-推理和-gpu-推理的速度差距有多大养老院应该选哪个"></a>
...
<a id="题目146量化后的模型还能继续微调吗"></a>
<a id="题目-146量化后的模型还能继续微调吗"></a>
...
<a id="题目147什么是groupsize它如何影响量化质量"></a>
<a id="题目-147什么是-group-size它如何影响量化质量"></a>
...
<a id="题目148ollama和vllm分别适合什么场景"></a>
<a id="题目-148ollama-和-vllm-分别适合什么场景"></a>
...
<a id="题目149如何将量化后的模型集成到asp.netcore后端"></a>
<a id="题目-149如何将量化后的模型集成到-aspnet-core-后端"></a>
...
<a id="题目150为什么养老院需要私有化部署有什么替代方案"></a>
<a id="题目-150为什么养老院需要私有化部署有什么替代方案"></a>
...
<a id="题目151ollama和vllm分别适合什么场景如何选择"></a>
<a id="题目-151ollama-和-vllm-分别适合什么场景如何选择"></a>
...
<a id="题目152如何将ai服务集成到asp.netcore后端"></a>
<a id="题目-152如何将-ai-服务集成到-aspnet-core-后端"></a>
...
<a id="题目153docker部署有什么优势如何用dockercompose编排ai服务"></a>
<a id="题目-153docker-部署有什么优势如何用-docker-compose-编排-ai-服务"></a>
...
<a id="题目154如何规划养老院的gpu硬件"></a>
<a id="题目-154如何规划养老院的-gpu-硬件"></a>
...
<a id="题目155什么是pagedattention为什么vllm比ollama快"></a>
<a id="题目-155什么是-pagedattention为什么-vllm-比-ollama-快"></a>
...
<a id="题目156如何监控ai服务的运行状态"></a>
<a id="题目-156如何监控-ai-服务的运行状态"></a>
...
<a id="题目157如何处理模型服务的高可用和故障恢复"></a>
<a id="题目-157如何处理模型服务的高可用和故障恢复"></a>
...
<a id="题目158如何优化ai服务的响应速度"></a>
<a id="题目-158如何优化-ai-服务的响应速度"></a>
...
<a id="题目159完整的养老院ai部署架构是什么样的"></a>
<a id="题目-159完整的养老院-ai-部署架构是什么样的"></a>
...
<a id="题目160什么是vlm它和纯文本大模型有什么区别"></a>
<a id="题目-160什么是-vlm它和纯文本大模型有什么区别"></a>
...
<a id="题目161如何通过api发送图片给多模态模型"></a>
<a id="题目-161如何通过-api-发送图片给多模态模型"></a>
...
<a id="题目162什么是多模态rag它和纯文本rag有什么区别"></a>
<a id="题目-162什么是多模态-rag它和纯文本-rag-有什么区别"></a>
...
<a id="题目163如何用vlm做ocr文字识别"></a>
<a id="题目-163如何用-vlm-做-ocr文字识别"></a>
...
<a id="题目164本地部署多模态模型需要什么硬件"></a>
<a id="题目-164本地部署多模态模型需要什么硬件"></a>
...
<a id="题目165多模态agent的工作流程是什么"></a>
<a id="题目-165多模态-agent-的工作流程是什么"></a>
...
<a id="题目166base64编码图片有什么优缺点"></a>
<a id="题目-166base64-编码图片有什么优缺点"></a>
...
<a id="题目167如何评估多模态模型的图片理解能力"></a>
<a id="题目-167如何评估多模态模型的图片理解能力"></a>
...
<a id="题目168多模态模型和传统ocr+llm的方案有什么区别"></a>
<a id="题目-168多模态模型和传统-ocr-llm-的方案有什么区别"></a>
...
<a id="题目169如何将多模态能力集成到养老院的asp.netcore系统中"></a>
<a id="题目-169如何将多模态能力集成到养老院的-aspnet-core-系统中"></a>
...
<a id="题目170什么是rlhf它的三个阶段分别做什么"></a>
<a id="题目-170什么是-rlhf它的三个阶段分别做什么"></a>
...
<a id="题目171dpo和rlhf有什么区别为什么dpo更流行"></a>
<a id="题目-171dpo-和-rlhf-有什么区别为什么-dpo-更流行"></a>
...
<a id="题目172什么是llm-as-judge它有什么优缺点"></a>
<a id="题目-172什么是-llm-as-judge它有什么优缺点"></a>
...
<a id="题目173养老院ai需要做哪些安全测试"></a>
<a id="题目-173养老院-ai-需要做哪些安全测试"></a>
...
<a id="题目174什么是kl散度它在rlhf中的作用是什么"></a>
<a id="题目-174什么是-kl-散度它在-rlhf-中的作用是什么"></a>
...
<a id="题目175如何构建养老院ai的评估数据集"></a>
<a id="题目-175如何构建养老院-ai-的评估数据集"></a>
...
<a id="题目176什么是红队测试redteaming"></a>
<a id="题目-176什么是红队测试red-teaming"></a>
...
<a id="题目177对齐税alignmenttax是什么"></a>
<a id="题目-177对齐税alignment-tax是什么"></a>
...
<a id="题目178如何持续改进已部署的ai模型"></a>
<a id="题目-178如何持续改进已部署的-ai-模型"></a>
...
<a id="题目179如何确保养老院ai的长期可靠性"></a>
<a id="题目-179如何确保养老院-ai-的长期可靠性"></a>
