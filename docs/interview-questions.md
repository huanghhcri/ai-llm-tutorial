...
- [第01章 Python基础（12 道）](#第01章-python基础)
- [第02章 深度学习基础（12 道）](#第02章-深度学习基础)
- [第03章 NLP基础与Tokenization（12 道）](#第03章-nlp基础与tokenization)

### 原理篇

- [第04章 Transformer架构详解（12 道）](#第04章-transformer架构详解)
- [第05章 大模型原理与发展脉络（10 道）](#第05章-大模型原理与发展脉络)

### 应用篇

- [第06章 大模型API调用实战（10 道）](#第06章-大模型api调用实战)
- [第07章 Prompt Engineering（10 道）](#第07章-prompt-engineering)
- [第08章 Embedding与向量数据库（11 道）](#第08章-embedding与向量数据库)
- [第09章 RAG检索增强生成（10 道）](#第09章-rag检索增强生成)

### 框架篇

- [第10章 LangChain与LangGraph（10 道）](#第10章-langchain与langgraph)
- [第11章 AI Agent开发（10 道）](#第11章-ai-agent开发)
- [第12章 多Agent系统（10 道）](#第12章-多agent系统)

### 进阶篇

- [第13章 模型微调（10 道）](#第13章-模型微调)
- [第14章 模型量化（10 道）](#第14章-模型量化)
- [第15章 私有化部署（10 道）](#第15章-私有化部署)
- [第16章 多模态大模型（10 道）](#第16章-多模态大模型)
- [第17章 模型评估与对齐（10 道）](#第17章-模型评估与对齐)
